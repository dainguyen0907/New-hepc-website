...
<section id="introduce" class="py-3">
    <div class="container text-center">
        <h2>Giới thiệu</h2>
        <div class="intro-content row border border-1 border-black p-3">
            <div class="into-left col-lg-7 col-xs-12">
                <p class="fw-bold fs-4">TRƯỜNG CAO ĐẲNG ĐIỆN LỰC <br /> THÀNH PHỐ HỒ CHÍ MINH</p>
                <img src="assets/images/unnamed.png" alt="Tàm nhìn và sứ mạng" class="mt-1">
            </div>
            <div class="intro-right col-lg-5 col-xs-12">
                <img src="assets/images/school1.png" alt="Tàm nhìn và sứ mạng" class="mt-1">
                <img src="assets/images/school2.png" alt="Tàm nhìn và sứ mạng" class="mt-1">
                <img src="assets/images/school3.png" alt="Tàm nhìn và sứ mạng" class="mt-1">
            </div>
        </div>
    </div>
</section>
<section id="activity">
    <div class="container text-center">
        <div class="row">
            <div class="col-12 col-md-4 col-lg-2 hvr-overline-from-center">
        ...
        <div class="row">
            <?php foreach ($News as $n): ?>
                <div class="col-12 col-md-6 col-lg-3" style="margin-bottom: 10px;">
                    <div class="card">
                        <img class="object-fit-cover ratio ratio-1x1" src="<?= $n['img'] != '' ? $n['img'] : 'assets/images/logo.png' ?>"
...
<section id="anouncements" class="py-3">
    <div class="banner">
        <h2>Thông báo</h2>
    </div>
    <div class="container">
                ...
                <div class="col-12 col-md-6 col-lg-3" style="margin-bottom: 10px;">
                    <div class="card text-center">
                        <img class="object-fit-cover"
                            src="<?= $anounce['img'] != '' ? $anounce['img'] : 'assets/images/thongbao.png' ?>"
                            class="card-img-top" alt="">
                        <div class="card-body">
                    ...
                    <?php foreach ($Admissions as $a): ?>
                        <div class="card border-light mb-3">
                            <div class="row g-0">
                                <div class="col-md-6">
                                    <img class="object-fit-cover"
                                        src="<?= $a['img'] != '' ? $a['img'] : 'assets/images/thongbao.png' ?>"
            ...
            <div class="col-12 col-md-5">
                ...
                <?php if ($Recruitments): ?>
                    <?php foreach ($Recruitments as $r): ?>
                        <div class='card'>
                            <div class='card-body'>
                                <i class="fa-solid fa-calendar"></i> <small>
                                    <?= $r['d_poss'] ?>
                                </small>
                                <h4> <a href="./tuyen-dung/<?= $r['link_description'] ?>">
                                        <?= $r['heading'] ?>
                                    </a> </h4>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <?php else: ?>
                <div class='text-center'>
                    <p class='text-uppercase fs-3 fw-bold'>KHÔNG TÌM THẤY VIDEO</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
