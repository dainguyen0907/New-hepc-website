<div class="dash-nav dash-nav-dark">
    ...
    <nav class="dash-nav-list">
        ...
        <?php if (session('userLogin')['id_q'] == 1): ?>
            <div class="dash-nav-dropdown">
                ...
                <div class="dash-nav-dropdown-menu">
                    ...
                    <a href="./admin/management/post" class="dash-nav-dropdown-item">Bài viết</a>
        ...
        <div class="dash-nav-dropdown">
            ...
            <div class="dash-nav-dropdown-menu">
                <a href="./admin/mypost" class="dash-nav-dropdown-item">Bài viết của tôi</a>
                <?php if (session('userLogin')['id_q'] == 1 || session('userLogin')['id_q'] == 2): ?>
                    <a href="./admin/control/Mygrouppost" class="dash-nav-dropdown-item">Bài viết phòng ban</a>
                <?php endif; ?>
                <a href="./admin/newpost" class="dash-nav-dropdown-item">Viết bài</a>
            </div>
        </div>
        <div class="dash-nav-dropdown">
            <a href="javascript::void(0)" class="dash-nav-item dash-nav-dropdown-toggle">
            ...
            <div class="dash-nav-dropdown">
                ...
                <div class="dash-nav-dropdown-menu">
                    <a href="./admin/control/Censorpicture" class="dash-nav-dropdown-item">
                        ...
                        <?php endif; ?>Ảnh hoạt động
                    </a>
                    <a href="./admin/control/Censorpost" class="dash-nav-dropdown-item">
                        <?php if ($censor_post > 0): ?>
                            <span class=" badge rounded-pill bg-danger">
                                <?= $censor_post ?>
                            </span>
                        <?php endif; ?>Bài viết
